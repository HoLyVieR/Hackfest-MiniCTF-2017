<?php
  ...
  function check_blacklist($content, $blacklist) {
    foreach ($blacklist as $item) {
      if (strpos(strtolower($content), $item) !== FALSE) {
        die("Blacklisted character detected : \"" . $item . "\"");
      }
    }
  }
  ...
  if ($count == 0) {
    $db->query("INSERT INTO flag VALUES ('FLAG-9bb32a4d481848127d5ade7824037363');");
  }
  ...
  if (isset($_POST['search'])) {
    check_blacklist($_POST['search'], array(";"," ","/*","union"));
